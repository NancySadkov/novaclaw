...
- `PortableGit-2.55.0.5-64-bit.7z.exe`, the Windows Bash and Git runtime; and
...
PortableGit's source offer is retained in `licenses/portable-git-NOTICE.md` and copied into the
