...
const opencodeClient = process.env.NOVACLAW_CLIENT

afterEach(() => {
  if (otelResourceAttributes === undefined) delete process.env.OTEL_RESOURCE_ATTRIBUTES
  else process.env.OTEL_RESOURCE_ATTRIBUTES = otelResourceAttributes

  if (opencodeClient === undefined) delete process.env.NOVACLAW_CLIENT
  else process.env.NOVACLAW_CLIENT = opencodeClient
})
