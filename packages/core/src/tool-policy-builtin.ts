 ...
 * `todo/projects.md` already records for the exclusion list's `bash` scan. Hard confinement is the
 * operator's boundary (`todo/jail.md`). What this buys is that the three or four commands that
