...
const VALID: Record<string, unknown> = {
  ...
  // writing no entry at all. Its key follows `ProjectFile.POLICY_ID_PATTERN`, the grammar shared by
  // novaclaw.json and the provider registry, so the three surfaces can always name each other.
