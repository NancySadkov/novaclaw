...
export const AGENT_PREAMBLE = [
  ...
  "Unless superior orders, never edit AGENTS.md or add notes comments stories into project's files - git has history. Maintain todo.md 50kb capped. Prune cruft move obsolete files to ./attic",
