import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@novaclaw/sdk/v2"
import { SessionTurn } from "@novaclaw/session-ui/session-turn"
import { SessionReview } from "@novaclaw/session-ui/session-review"
import { DataProvider } from "@novaclaw/session-ui/context"
import { FileComponentProvider } from "@novaclaw/ui/context/file"
import { WorkerPoolProvider } from "@novaclaw/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@novaclaw/ui/logo"
import { IconButton } from "@novaclaw/ui/icon-button"
import { ProviderIcon } from "@novaclaw/ui/provider-icon"
import { iife } from "@novaclaw/core/util/iife"
...
import { MessageNav } from "@novaclaw/session-ui/message-nav"
import { FileSSR } from "@novaclaw/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@novaclaw/session-ui/pierre/worker").then((m) => ({
