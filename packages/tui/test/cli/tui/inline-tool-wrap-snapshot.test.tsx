...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "NOVACLAW.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/novaclaw/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/novaclaw (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/novaclaw/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
  ...
  },
  {
    icon: "✱",
    label:
      'Grep "export const NOVACLAW_DB|NOVACLAW_DB|NOVACLAW_DEV|Global\\.Path\\.data|data =" in packages/novaclaw/src (115 matches)',
  },
] as const
