import type { TuiPlugin, TuiPluginApi } from "@novaclaw/plugin/tui"
...
function View(props: { api: TuiPluginApi; sessionID: string }) {
  ...
  return (
    <box gap={1}>
        ...
        >
          ...
          <box flexGrow={1} gap={1}>
            ...
            <text fg={theme().textMuted}>
              Connect a provider to start using models, including Claude, GPT, Gemini etc
            </text>
      ...
      <text fg={theme().textMuted}>
        <span style={{ fg: theme().success }}>•</span> <b>Nova</b>
