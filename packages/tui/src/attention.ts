...
import defaultSoundPath from "@novaclaw/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@novaclaw/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@novaclaw/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@novaclaw/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@novaclaw/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@novaclaw/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "novaclaw"
const DEFAULT_PACK_ID = "novaclaw.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "NovaClaw Default",
  builtin: true,
  sounds: {
