      ...
      description={
        {
          opencode: (
            <box gap={1}>
              ...
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://novaclaw.app/zen</span> to get a key
              </text>
            </box>
          ),
          "opencode-go": (
            <box gap={1}>
              ...
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://novaclaw.app/go</span> and enable OpenCode Go
              </text>
            </box>
          ),
