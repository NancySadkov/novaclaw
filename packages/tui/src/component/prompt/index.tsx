...
import type { AssistantMessage, FilePart, UserMessage } from "@novaclaw/sdk/v2"
...
import { NOVACLAW_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useNovaclawKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.NOVACLAW_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
