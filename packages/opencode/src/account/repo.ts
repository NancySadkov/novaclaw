...
import { AccountStateTable, AccountTable } from "@novaclaw/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@novaclaw/AccountRepo") {}
