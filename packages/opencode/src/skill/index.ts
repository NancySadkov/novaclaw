...
const CUSTOMIZE_NOVACLAW_SKILL_NAME = "customize-opencode"
const CUSTOMIZE_NOVACLAW_SKILL_DESCRIPTION =
  "Use ONLY when the user is editing or creating opencode's own configuration: novaclaw.json, novaclaw.jsonc, files under .novaclaw/, or files under ~/.config/novaclaw/. Also use when creating or fixing opencode agents, subagents, skills, plugins, MCP servers, or permission rules. Do not use for the user's own application code, or for any project that is not configuring opencode itself."
const CUSTOMIZE_NOVACLAW_SKILL_BODY = SkillPlugin.CustomizeOpencodeContent
...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  for (const dir of configDirs) {
    yield* scan(state, dir, NOVACLAW_SKILL_PATTERN)
  }
