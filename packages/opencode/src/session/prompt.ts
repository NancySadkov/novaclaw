...
import { MAX_STEPS_PROMPT } from "@novaclaw/core/session/runner/max-steps"
...
export class Service extends Context.Service<Service, Interface>()("@novaclaw/SessionPrompt") {}
