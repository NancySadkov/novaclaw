...
import { buildPrompt } from "@novaclaw/core/session/compaction"
import { SessionCompactionEvent } from "@novaclaw/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@novaclaw/SessionCompaction") {}
