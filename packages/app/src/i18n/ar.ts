...
export const dict = {
  ...
  "error.page.report.prefix": "إذا استمرت المشكلة، انسخ تفاصيل الخطأ أو صدّر السجلات لمن يدير هذه النسخة.",
  ...
  "settings.general.section.notifications": "إشعارات",
  "settings.general.notifications.description": "إشعارات عندما يحتاج إليك أحد الضباط أو يحدث خطأ.",
  ...
  "home.app.models.name": "النماذج",
  "home.app.models.subtitle": "أضف النماذج وفعّلها واضبطها على هذا النظام",
  "home.app.social.name": "Swarm",
  "home.app.social.subtitle": "اربط Nova الخاصة بك بنسخ أخرى عبر شبكة DHT",
