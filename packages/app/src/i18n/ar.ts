...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من NovaClaw",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في NovaClaw.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في NovaClaw.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في NovaClaw.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في novaclaw.json",
  ...
  "dialog.server.description": "تبديل خادم NovaClaw الذي يتصل به هذا التطبيق.",
  ...
  "toast.update.description": "نسخة جديدة من NovaClaw ({{version}}) متاحة الآن للتثبيت.",
  ...
  "sidebar.gettingStarted.line1": "يتضمن NovaClaw نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم NovaClaw داخل WSL على Windows.",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور NovaClaw على جهازك",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل NovaClaw",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من NovaClaw.",
