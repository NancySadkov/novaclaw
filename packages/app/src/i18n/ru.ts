...
export const dict = {
  ...
  "error.page.report.prefix": "Если проблема повторяется, скопируйте детали ошибки или экспортируйте журналы для администратора этого экземпляра.",
  ...
  "home.app.social.subtitle": "Подключите Nova к другим экземплярам через сеть DHT",
