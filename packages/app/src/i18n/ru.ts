...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от NovaClaw",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в NovaClaw.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в NovaClaw.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в NovaClaw.",
  ...
  "dialog.server.description": "Переключите сервер NovaClaw к которому подключается приложение.",
  ...
  "toast.update.description": "Новая версия NovaClaw ({{version}}) доступна для установки.",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (novaclaw.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что NovaClaw пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "NovaClaw включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер NovaClaw внутри WSL на Windows.",
  ...
  "settings.general.row.appearance.description": "Настройте как NovaClaw выглядит на вашем устройстве",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске NovaClaw",
  ...
  "home.app.chats.name": "Чаты",
  "home.app.chats.subtitle": "Ваши беседы и всё, что ещё выполняется",
  "home.app.notes.name": "Заметки",
  "home.app.notes.subtitle": "Повседневные заметки, доступные вашим агентам",
  "home.app.calendar.name": "Календарь",
  "home.app.calendar.subtitle": "Запускайте агентов по повторяющемуся расписанию",
  ...
  "home.app.terminal.subtitle": "Оболочка — на случай, если она понадобится",
  "home.app.registry.name": "Реестр",
  ...
  "home.app.trash.subtitle": "Восстановите всё удалённое за последние 2 дня",
  "home.app.social.name": "Сообщество",
  "home.app.social.subtitle": "Discord, Reddit и сайт — другие пользователи NovaClaw",
  "home.app.help.name": "Справка",
  "home.app.help.subtitle": "Краткий обзор возможностей NovaClaw",
  "home.app.settings.name": "Настройки",
  "home.app.settings.subtitle": "Провайдеры, модели, серверы, восстановление",
