...
export const dict = {
  ...
  "session.error.modelMissing": "Этот чат настроен на модель, которую её провайдер больше не предоставляет. Выберите для чата другую модель.",
  ...
  "home.app.models.name": "Модели",
  "home.app.models.subtitle": "Добавляйте, включайте и настраивайте модели, которые может запускать этот экземпляр",
  ...
  "home.app.skills.name": "Навыки",
  "home.app.skills.subtitle": "Дополнительные инструкции, которым могут следовать ваши агенты, и кто написал каждую",
