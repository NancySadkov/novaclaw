...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por NovaClaw",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en NovaClaw.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en NovaClaw.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en NovaClaw.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de NovaClaw se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de NovaClaw ({{version}}) está disponible para instalar.",
  ...
  "sidebar.gettingStarted.line1": "NovaClaw incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor NovaClaw dentro de WSL en Windows.",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve NovaClaw en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si NovaClaw sigue el tema del sistema, claro u oscuro",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia NovaClaw",
  ...
  "home.app.chats.subtitle": "Tus conversaciones, y todo lo que sigue en marcha",
