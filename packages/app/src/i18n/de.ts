...
export const dict = {
  ...
  "settings.general.section.notifications": "Benachrichtigungen",
  "settings.general.notifications.description": "Hinweise, wenn ein Offizier dich braucht oder ein Fehler auftritt.",
