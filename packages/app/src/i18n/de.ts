...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von NovaClaw",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in NovaClaw zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in NovaClaw zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in NovaClaw zu nutzen.",
  ...
  "dialog.plugins.empty": "In novaclaw.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den NovaClaw-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von NovaClaw ({{version}}) ist zur Installation verfügbar.",
  ...
  "sidebar.gettingStarted.line1": "NovaClaw enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "NovaClaw-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von NovaClaw automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von NovaClaw.",
  ...
  "home.app.memory-graph.name": "Gedächtnisgraph",
  "home.app.memory-graph.subtitle": "Erkunde als Graph, woran sich NovaClaw erinnert",
