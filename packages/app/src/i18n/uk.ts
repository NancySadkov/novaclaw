...
export const dict = {
  ...
  "home.app.models.name": "Моделі",
  "home.app.models.subtitle": "Додавайте, вмикайте та налаштовуйте моделі, які може запускати цей екземпляр",
  ...
  "home.app.skills.name": "Навички",
  "home.app.skills.subtitle": "Додаткові інструкції, яких можуть дотримуватися ваші агенти, і хто написав кожну",
