...
export const dict = {
  ...
  "error.page.report.prefix": "Якщо проблема повторюється, скопіюйте деталі помилки або експортуйте журнали для адміністратора цього екземпляра.",
  ...
  "home.app.social.subtitle": "З’єднайте свою Nova з іншими інстансами через мережу DHT",
