export const dict = {
  ...
  "settings.models.new.managed.card": "Let Nova install and run a tested private model on this instance.",
  "settings.models.new.managed.title": "Run a model on this computer",
  "settings.models.new.managed.description":
    "Nova downloads a verified model and AI engine, checks that they fit, and keeps the server running for you.",
  ...
  "settings.models.new.managed.install": "Download and use",
  ...
  "home.app.chats.subtitle": "Your conversations, and everything still running",
  ...
  "home.app.memory-graph.name": "Memory graph",
  "home.app.memory-graph.subtitle": "Explore what NovaClaw remembers, as a graph",
