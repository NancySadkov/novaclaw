export const dict = {
  ...
  "prompt.toast.attachmentsUnsupportedHere.description":
    "Shell input can't carry a file yet. Send the attachment as an ordinary message instead.",
  ...
  "context.breakdown.capacity": "{{used}} of {{limit}}",
  "context.breakdown.available": "Available",
  "context.breakdown.export": "Export {{label}} as raw text",
  "context.breakdown.exportHint": "Select any colored segment to export its raw text.",

  "context.messages.you": "You",
  "context.tokens.title": "Tokens",
  "context.tokens.input": "Input",
  "context.tokens.output": "Output",
  "context.tokens.reasoning": "Reasoning",
  "context.tokens.cacheRead": "Cache read",
  ...
  "context.import.session": "Import Session",
  "context.import.working": "Importing…",
  "context.import.done": "Imported {{count}} messages",
  "context.import.skipped": "{{count}} message(s) this harness does not model were skipped.",
  "context.import.failed": "That file could not be imported as a session",
  ...
  "settings.trash.contents": "Recently deleted",
  ...
  "settings.models.live.idle": "idle",
  "settings.models.live.using": "{{count}} using",
  ...
  "settings.models.config.minRun.desc":
    "How long one agent keeps this device before another may take it. 0 lets the scheduler decide.",
  "settings.models.config.minRun.desc.more":
    "On a model whose context is memory-mapped (a large expert index), every switch to a different agent re-prefills a cold context and can drop throughput from tens of tokens/s to one or two. A minimum run time keeps the most recently active agent on the device across its own quick turns, so a looping agent does not hand its warm pages to a peer. It never delays your own interactive turn.",
  "settings.models.config.scheduler.note":
    "These controls belong to the device (the machine serving the model), not to the model itself — every model served by the same endpoint shares them.",
  ...
  "settings.models.config.toast.defaultSet": "{{model}} is now the default model",
  "settings.models.config.toast.defaultFailed": "Could not set the default model: {{error}}",
  "settings.models.config.default.make": "Make default",
  ...
  "settings.models.enable.toast.on": "Enabled {{model}}",
  "settings.models.enable.toast.off": "Disabled {{model}} — agents now resolve another model",
  "settings.models.enable.toast.failed": "Could not change {{model}}: {{error}}",
  ...
  "contacts.order.hint":
    "Drag sideways to arrange · Swipe vertically to scroll · Alt + arrow keys to move · Right-click or hold for actions",
  ...
  "contacts.workers.stopping": "Stopping…",
  "contacts.workers.stopped": "Worker stopped",
  "contacts.workers.stopFailed": "Could not stop worker",
  "contacts.workers.stopReason": "Why are you stopping this worker?",
  "contacts.workers.stopReasonPlaceholder": "For example: duplicate of the character-assets worker",
