...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "NovaClawが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、NovaClawで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してNovaClawで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、NovaClawで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するNovaClawサーバーを切り替えます。",
  ...
  "toast.update.description": "NovaClawの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "sidebar.gettingStarted.line1": "NovaClawには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でNovaClawサーバーを実行します。",
  ...
  "settings.general.row.appearance.description": "デバイスでのNovaClawの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "NovaClawがシステム、ライト、またはダークテーマに従うかを選択します",
  ...
  "settings.updates.row.startup.description": "NovaClaw の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "NovaClaw は最新バージョンです。",
