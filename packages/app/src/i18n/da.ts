...
export const dict = {
  ...
  "home.app.tasks.name": "Opgaver",
  "home.app.tasks.subtitle": "Alt dine agenter kører, og alt de har afsluttet",
  "home.app.tasks.stat.running": "kører",
  "home.app.tasks.stat.throughput": "t/s",
  "home.app.tasks.stat.memory": "hukommelse",
  ...
  "home.app.contacts.subtitle": "Kollegerne denne NovaClaw beskæftiger, og hvad hver enkelt husker",
  ...
  "home.app.skills.name": "Færdigheder",
  "home.app.skills.subtitle": "Ekstra instruktioner dine agenter kan følge, og hvem der har skrevet hver enkelt",
