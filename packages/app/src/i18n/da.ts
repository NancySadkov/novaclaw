...
export const dict = {
  ...
  "error.page.report.prefix": "Hvis problemet fortsætter, så kopiér fejldetaljerne eller eksportér logfilerne til den, der administrerer denne instans.",
  ...
  "home.app.social.subtitle": "Forbind din Nova med andre instanser gennem DHT-sværmen",
