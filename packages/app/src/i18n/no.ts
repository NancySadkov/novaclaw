...
export const dict = {
  ...
  "error.page.report.prefix": "Hvis problemet fortsetter, kopier feildetaljene eller eksporter loggene til den som administrerer denne instansen.",
  ...
  "home.app.models.subtitle": "Legg til, aktiver og finjuster modellene denne instansen kan kjøre",
  "home.app.social.name": "Swarm",
  "home.app.social.subtitle": "Koble din Nova til andre instanser gjennom DHT-svermen",
