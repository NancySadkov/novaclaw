...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av NovaClaw",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i NovaClaw.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i NovaClaw.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i NovaClaw.",
  ...
  "dialog.server.description": "Bytt hvilken NovaClaw-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av NovaClaw ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (novaclaw.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at NovaClaw ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "NovaClaw inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør NovaClaw-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for NovaClaw",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan NovaClaw ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om NovaClaw skal følge systemets, lyst eller mørkt tema",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når NovaClaw starter",
  ...
  "home.app.terminal.subtitle": "Et skall, for når du vil ha et",
  ...
  "home.app.trash.subtitle": "Gjenopprett alt som er slettet de siste 2 dagene",
  "home.app.social.name": "Fellesskap",
  "home.app.social.subtitle": "Discord, Reddit og nettstedet — andre som bruker NovaClaw",
  "home.app.help.name": "Hjelp",
