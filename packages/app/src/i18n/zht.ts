...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "NovaClaw 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 NovaClaw 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 NovaClaw 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 NovaClaw 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 NovaClaw 伺服器。",
  ...
  "toast.update.description": "NovaClaw 有新版本 ({{version}}) 可安裝。",
  ...
  "sidebar.gettingStarted.line1": "NovaClaw 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 NovaClaw 伺服器。",
  ...
  "settings.general.row.appearance.description": "自訂 NovaClaw 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 NovaClaw 要跟隨系統、淺色或深色主題",
  ...
  "settings.updates.row.startup.description": "在 NovaClaw 啟動時自動檢查更新",
  ...
  "home.app.chats.subtitle": "你的對話，以及仍在執行的一切",
