...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "NovaClaw에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 NovaClaw에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 NovaClaw에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 NovaClaw에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.plugins.empty": "novaclaw.json에 구성된 플러그인",
  ...
  "dialog.server.description": "이 앱이 연결할 NovaClaw 서버를 전환합니다.",
  ...
  "toast.update.description": "NovaClaw의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 NovaClaw 팀에 제보해 주세요: ",
  ...
  "error.chain.checkConfig": "구성(novaclaw.json)의 공급자/모델 이름을 확인하세요",
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: NovaClaw는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "NovaClaw에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 NovaClaw 서버를 실행합니다.",
  ...
  "settings.general.row.appearance.description": "기기에서 NovaClaw가 보이는 방식 사용자 지정",
  ...
  "settings.updates.row.startup.description": "NovaClaw를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 NovaClaw를 사용 중입니다.",
  ...
  "home.app.recipes.subtitle": "에이전트가 요리할 수 있는 준비된 프롬프트",
  "home.app.files.name": "파일",
  "home.app.files.subtitle": "폴더를 살펴보고 AI에게 작업을 맡기세요",
  "home.app.terminal.name": "터미널",
  "home.app.terminal.subtitle": "필요할 때 쓰는 셸",
  "home.app.registry.name": "레지스트리",
  ...
  "home.app.trash.subtitle": "최근 2일 이내에 삭제한 항목 복원",
  "home.app.social.name": "커뮤니티",
  "home.app.social.subtitle": "Discord, Reddit, 웹사이트 — NovaClaw를 쓰는 사람들",
  "home.app.help.name": "도움말",
