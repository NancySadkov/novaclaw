...
export const dict = {
  ...
  "settings.general.section.notifications": "알림",
  "settings.general.notifications.description": "오피서가 도움을 요청하거나 오류가 발생하면 알립니다.",
  ...
  "settings.general.row.terminalFont.description": "터미널에 사용되는 글꼴을 사용자 지정",
  ...
  "home.app.models.name": "모델",
  "home.app.models.subtitle": "이 인스턴스에서 실행할 수 있는 모델을 추가, 활성화 및 조정합니다",
