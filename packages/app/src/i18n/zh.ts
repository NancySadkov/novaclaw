...
export const dict = {
  ...
  "error.page.report.prefix": "如果问题持续，请复制错误详情或导出日志，交给管理此实例的人。",
  ...
  "home.app.models.name": "模型",
  "home.app.models.subtitle": "添加、启用并调整此实例可以运行的模型",
  "home.app.social.name": "Swarm",
  "home.app.social.subtitle": "通过 DHT 集群将你的 Nova 连接到其他实例",
