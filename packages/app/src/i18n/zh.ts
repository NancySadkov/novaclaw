...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "NovaClaw 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 NovaClaw 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 NovaClaw 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 NovaClaw 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 NovaClaw 服务器。",
  ...
  "toast.update.description": "NovaClaw 有新版本 ({{version}}) 可安装。",
  ...
  "sidebar.gettingStarted.line1": "NovaClaw 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 NovaClaw 服务器。",
  ...
  "settings.general.row.appearance.description": "自定义 NovaClaw 在你的设备上的外观",
  ...
  "settings.updates.row.startup.description": "在 NovaClaw 启动时自动检查更新",
