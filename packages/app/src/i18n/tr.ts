...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "NovaClaw tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve NovaClaw'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve NovaClaw'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak NovaClaw'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi NovaClaw sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "NovaClaw'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "sidebar.gettingStarted.line1": "NovaClaw ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "NovaClaw Masaüstü",
  ...
  "settings.desktop.wsl.description": "NovaClaw sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.appearance.description": "NovaClaw'un cihazınızdaki görünümünü özelleştirin",
  ...
  "settings.updates.row.startup.description": "NovaClaw başladığında otomatik güncelleme kontrolü yap",
