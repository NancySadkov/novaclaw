...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par NovaClaw",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans NovaClaw.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans NovaClaw.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans NovaClaw.",
  ...
  "dialog.server.description": "Changez le serveur NovaClaw auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'NovaClaw ({{version}}) est maintenant disponible pour installation.",
  ...
  "sidebar.gettingStarted.line1":
    "NovaClaw inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur NovaClaw dans WSL sur Windows.",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'NovaClaw sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si NovaClaw suit le thème système, clair ou sombre",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'NovaClaw",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'NovaClaw.",
  ...
  "home.app.memory-graph.name": "Graphe de mémoire",
  "home.app.memory-graph.subtitle": "Explorez ce dont NovaClaw se souvient, sous forme de graphe",
