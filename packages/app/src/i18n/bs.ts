...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje NovaClaw",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u NovaClaw-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u NovaClaw-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u NovaClaw-u.",
  ...
  "dialog.server.description": "Promijeni na koji se NovaClaw server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija NovaClaw-a ({{version}}) je dostupna za instalaciju.",
  ...
  "sidebar.gettingStarted.line1": "NovaClaw uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni NovaClaw server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako NovaClaw izgleda na tvom uređaju",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se NovaClaw pokrene",
