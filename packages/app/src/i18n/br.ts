...
export const dict = {
  ...
  "settings.general.section.notifications": "Notificações",
  "settings.general.notifications.description": "Alertas quando um oficial precisa de você ou ocorre uma falha.",
