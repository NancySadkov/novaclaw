...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo NovaClaw",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no NovaClaw.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no NovaClaw.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no NovaClaw.",
  ...
  "dialog.plugins.empty": "Plugins configurados em novaclaw.json",
  ...
  "dialog.server.description": "Trocar para qual servidor NovaClaw este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do NovaClaw ({{version}}) está disponível para instalação.",
  ...
  "sidebar.gettingStarted.line1": "NovaClaw inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor NovaClaw dentro do WSL no Windows.",
  ...
  "settings.general.row.appearance.description": "Personalize como o NovaClaw aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o NovaClaw segue o tema do sistema, claro ou escuro",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o NovaClaw iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do NovaClaw.",
  ...
  "home.app.chats.name": "Conversas",
  "home.app.chats.subtitle": "Suas conversas, e tudo que ainda está rodando",
  ...
  "home.app.memory-graph.name": "Grafo de memória",
  "home.app.memory-graph.subtitle": "Explore o que o NovaClaw lembra, como um grafo",
