...
export const dict = {
  ...
  "error.page.report.prefix": "Jeśli problem się powtarza, skopiuj szczegóły błędu lub wyeksportuj dzienniki dla osoby zarządzającej tą instancją.",
  ...
  "settings.general.section.notifications": "Powiadomienia",
  "settings.general.notifications.description": "Alerty, gdy oficer potrzebuje pomocy lub wystąpi błąd.",
  ...
  "home.app.models.name": "Modele",
  "home.app.models.subtitle": "Dodawaj, włączaj i dostrajaj modele, które może uruchamiać ta instancja",
  "home.app.social.name": "Swarm",
  "home.app.social.subtitle": "Połącz swoją Novę z innymi instancjami przez sieć DHT",
