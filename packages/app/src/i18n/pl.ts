...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez NovaClaw",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w NovaClaw.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w NovaClaw.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w NovaClaw.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w novaclaw.json",
  ...
  "dialog.server.description": "Przełącz serwer NovaClaw, z którym łączy się ta aplikacja.",
  ...
  "sidebar.gettingStarted.line1": "NovaClaw zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd NovaClaw na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy NovaClaw ma używać motywu systemowego, jasnego czy ciemnego",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania NovaClaw",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji NovaClaw.",
