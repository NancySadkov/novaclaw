...
function diff(value: unknown): value is Diff {
  ...
  if (
    "patchUnavailableReason" in value &&
    value.patchUnavailableReason !== undefined &&
    value.patchUnavailableReason !== "binary" &&
    value.patchUnavailableReason !== "too_large" &&
    value.patchUnavailableReason !== "metadata_only"
  )
    return false
