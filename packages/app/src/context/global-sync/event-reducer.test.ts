...
import type { Message, Part, PermissionRequest, Project, QuestionRequest, Session } from "@novaclaw/sdk/v2/client"
...
describe("applyDirectoryEvent", () => {
  ...
  test("cleans caches for trimmed sessions on session.created", () => {
    ...
    applyDirectoryEvent({
      ...
      setStore,
      push() {},
      directory: "/tmp",      setSessionTodo(sessionID, value) {
