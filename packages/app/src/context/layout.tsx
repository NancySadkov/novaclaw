...
import type { ProjectAvatarVariant } from "@novaclaw/ui/v2/project-avatar-v2"
  ...
  init: () => {
    ...
    const migrate = (value: unknown) => {
      ...
      const migratedReview = (() => {
        ...
        const { panelOpened: _, ...preferences } = review
        return preferences
      })()
    ...
    return {
      ...
      view(sessionKey: string | Accessor<string>) {
        ...
        return {
          ...
          clearScroll(tab: string) {
            scroll.clearScroll(key(), tab)
          },
          todoCollapsed: {
