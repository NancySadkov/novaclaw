// V1-nuke slice D: re-homed from schema/src/v1/question.ts — the LIVE question vocabulary.
export * as QuestionRequest from "./question-request"
...
export const Tool = Schema.Struct({ messageID: SessionMessage.ID, callID: Schema.String }).annotate({
