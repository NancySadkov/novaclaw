...
class Database extends Context.Service<Database, DatabaseShape>()("@novaclaw/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@novaclaw/example/UserStore") {
