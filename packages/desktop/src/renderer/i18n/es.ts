export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de NovaClaw",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de NovaClaw. ¿Quieres instalarla y reiniciar?",
