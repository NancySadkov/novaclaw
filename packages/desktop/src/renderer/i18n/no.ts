export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av NovaClaw",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av NovaClaw er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.cli.installed.message":
    "CLI installert til {{path}}\n\nStart terminalen på nytt for å bruke 'novaclaw'-kommandoen.",
