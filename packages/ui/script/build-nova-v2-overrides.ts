...
const themePath = import.meta.dir + "/../src/theme/themes/nova.json"
...
console.log("Updated nova.json v2Overrides", Object.keys(light).length, "tokens per mode")
...
function readTokens(mode: "light" | "dark") {
  ...
  if (!block) throw new Error(`Missing ${mode} Nova tokens`)
