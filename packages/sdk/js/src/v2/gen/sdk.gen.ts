...
class ApiV2Agent extends NovaClawApiClient {
  ...
  /**
   * Read an officer team's colleague chat
   *
   ...
   */
  public teamChat<ThrowOnError extends boolean = false>(
    parameters: {
      agentID: string
      location?: {
        directory?: string
    ...
    return (options?.client ?? this.client).get<T.V2AgentTeamChatResponses, T.V2AgentTeamChatErrors, ThrowOnError>({
