...
import type {
  ...
  V2FsReadErrors,
  V2FsReadResponses,
  V2FsSnapshotReadErrors,
  V2FsSnapshotReadResponses,
  V2HealthGetErrors,
  ...
  V2SessionConfigErrors,
  V2SessionConfigResponses,
...
export class Session extends HeyApiClient {
  ...
  public config<ThrowOnError extends boolean = false>(
    ...
    const params = buildClientParams([parameters], [{ args: [{ in: "path", key: "sessionID" }] }])
    return (options?.client ?? this.client).get<V2SessionConfigResponses, V2SessionConfigErrors, ThrowOnError>({
      ...
      [
        {
          args: [
            { in: "query", key: "location" },
            { in: "query", key: "snapshot" },
            { in: "query", key: "path" },
          ],
        },
      ],
    )
    return (options?.client ?? this.client).get<V2FsSnapshotReadResponses, V2FsSnapshotReadErrors, ThrowOnError>({
