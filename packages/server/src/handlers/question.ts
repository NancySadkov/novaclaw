...
import { QuestionApi, handlerLayer } from "../handler-api"
import { QuestionNotFoundError } from "@novaclaw/protocol/errors"
...
export const QuestionHandler = handlerLayer(
  HttpApiBuilder.group(QuestionApi, "server.question", (handlers) =>
    Effect.gen(function* () {
