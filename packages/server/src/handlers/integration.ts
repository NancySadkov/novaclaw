...
import { IntegrationApi, handlerLayer } from "../handler-api"
...
export const IntegrationHandler = handlerLayer(
  HttpApiBuilder.group(IntegrationApi, "server.integration", (handlers) =>
    Effect.gen(function* () {
      return handlers
        .handle(
          "integration.list",
