...
const it = testEffectShared(Layer.mergeAll(FSUtil.defaultLayer, Snapshot.defaultLayer, testInstanceStore, httpApiLayer))
...
describe("project.initGit endpoint", () => {
  it.instance("initializes git and reloads immediately", () =>
    Effect.gen(function* () {
      ...
      expect(yield* fs.exists(path.join(tmp.directory, ".git", "novaclaw"))).toBe(false)
