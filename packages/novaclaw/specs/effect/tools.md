...
Practical reference for the current tool-migration state in `packages/novaclaw`.
...
Tool tests should use the existing Effect helpers in `packages/novaclaw/test/lib/effect.ts`:
