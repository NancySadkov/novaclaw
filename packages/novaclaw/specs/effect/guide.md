...
How we write Effect code in `packages/novaclaw`. The companion roadmap is
[`todo.md`](./todo.md).
...
export class Service extends Context.Service<Service, Interface>()("@novaclaw/Foo") {}
...
Read novaclaw runtime flags through
