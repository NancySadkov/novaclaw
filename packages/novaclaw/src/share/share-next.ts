...
import type * as SDK from "@novaclaw/sdk/v2"
...
import { SessionShareTable } from "@novaclaw/core/share/sql"
...
export class Service extends Context.Service<Service, Interface>()("@novaclaw/ShareNext") {}
