...
import type { AssistantMessage as OpenCodeAssistantMessage, Message } from "@novaclaw/sdk/v2"
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@novaclaw/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@novaclaw/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@novaclaw/ACPUsage") {}
