...
import type { AssistantMessage, Message, OpencodeClient, SessionMessageResponse } from "@novaclaw/sdk/v2"
...
export class Service extends Context.Service<Service, Interface>()("@novaclaw/ACP/Service") {}
...
function defaultModelFromConfig(
  ...
  // Use the configured model, else the sorted best model, to keep the response deterministic.
