...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@novaclaw/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@novaclaw/ACPDirectory") {}
