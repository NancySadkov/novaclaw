...
import { errorMessage } from "@novaclaw/tui/util/error"
...
import { win32InstallCtrlCGuard } from "@novaclaw/tui/terminal-win32"

declare global {
  const NOVACLAW_WORKER_PATH: string
}
...
async function target() {
  if (typeof NOVACLAW_WORKER_PATH !== "undefined") return NOVACLAW_WORKER_PATH
