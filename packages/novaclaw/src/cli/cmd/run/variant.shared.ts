...
//
// The saved variant persists across sessions in ~/.local/state/novaclaw/model.json
...
class Service extends Context.Service<Service, VariantService>()("@novaclaw/RunVariant") {}
