...
import { openEditor } from "@novaclaw/tui/editor"
import { registerNovaclawKeymap } from "@novaclaw/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerNovaclawKeymap(keymap, renderer, input.tuiConfig)
