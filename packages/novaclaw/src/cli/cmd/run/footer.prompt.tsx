...
import { normalizePromptContent } from "@novaclaw/tui/editor"
...
import { NOVACLAW_BASE_MODE, useBindings } from "@novaclaw/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close NovaClaw" } satisfies SlashOption,
    ]
