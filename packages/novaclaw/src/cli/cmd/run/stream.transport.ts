...
import type { Event, GlobalEvent, NovaclawClient } from "@novaclaw/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@novaclaw/RunStreamTransport") {}
