// Dependability P4: the pure restart policy for `novaclaw serve` supervision — extracted so the
// ladder (backoff growth/reset, fast-crash giveup, clean-exit stop) is unit-testable apart from
// process plumbing.
