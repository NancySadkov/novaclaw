...
import type { LLMClientService } from "@novaclaw/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@novaclaw/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via novaclaw's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @novaclaw/llm. It
