import type { JsonSchema, LLMRequest, ProviderMetadata } from "@novaclaw/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@novaclaw/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @novaclaw/llm request objects from novaclaw's session/AI SDK-shaped data.
  return LLM.request({
