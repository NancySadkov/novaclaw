...
import { ProjectDirectoryTable, ProjectTable } from "@novaclaw/core/project/sql"
...
export class Service extends Context.Service<Service, Interface>()("@novaclaw/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.NOVACLAW_FAKE_VCS)
